...
export default function Collaboration() {
  ...
  const [collabJobs] = useState([
    ...
    },
    {
      ...
      postedAt: '2 days ago',
      skills: ['React Native', 'Figma', 'Expo'],
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 pb-10 items-stretch">
            {filteredJobs.map((job) => (
              ...
              >
                ...
                <div className="flex items-start justify-between mb-5">
                  <div className="flex items-center gap-3">
                    <img 
                      ...
                      alt={job.posterName} 
                      className="w-10 h-10 rounded-sm object-cover shrink-0 border border-gray-200"
                    />
                    <div>
                ...
                <div className="mb-6">
                  <div className="flex flex-wrap gap-2">
                    {job.skills.map((skill, index) => (
                      <span key={index} className="bg-gray-100 border border-gray-200 text-gray-800 text-[10px] font-bold px-2.5 py-1 rounded-sm uppercase tracking-wider">
                        {skill}
                      </span>
                    ))}
                  </div>
                ...
                {/* Meta Details Grid */}
                <div className="grid grid-cols-3 gap-4 mb-6 p-4 bg-gray-50 border border-gray-100 rounded-sm">
                  <div>
                  ...
                  <div>
                    <p className="text-[10px] text-gray-500 font-bold uppercase tracking-wider mb-1">Deadline</p>
                ...
                <div className="pt-4 border-t border-gray-100 flex items-center gap-3 mt-auto">
                  ...
                  <button 
                    ...
                    className="flex-1 bg-black text-[#F5F216] py-3 rounded-sm text-sm font-bold hover:bg-gray-800 transition-colors text-center"
                  >
                    Apply Now
                  </button>
                </div>
